# Upgrade project feedback-submission-solution-client-side-solution to v1.23.2
...
```sh
npm i -SE @microsoft/sp-core-library@1.23.2
```
...
```sh
npm i -SE @microsoft/sp-lodash-subset@1.23.2
```
...
```sh
npm i -SE @microsoft/sp-office-ui-fabric-core@1.23.2
```
...
```sh
npm i -SE @microsoft/sp-webpart-base@1.23.2
```
...
```sh
npm i -SE @microsoft/sp-property-pane@1.23.2
```
...
```sh
npm i -SE @microsoft/sp-component-base@1.23.2
```
...
```sh
npm i -DE @microsoft/sp-module-interfaces@1.23.2
```
...
```sh
npm i -DE @microsoft/eslint-plugin-spfx@1.23.2
```
...
```sh
npm i -DE @microsoft/eslint-config-spfx@1.23.2
```
...
```sh
npm i -DE @microsoft/spfx-web-build-rig@1.23.2
```
...
```sh
npm i -DE @microsoft/spfx-heft-plugins@1.23.2
```
...
npm i -SE @microsoft/sp-core-library@1.23.2 @microsoft/sp-lodash-subset@1.23.2 @microsoft/sp-office-ui-fabric-core@1.23.2 @microsoft/sp-webpart-base@1.23.2 @microsoft/sp-property-pane@1.23.2 @microsoft/sp-component-base@1.23.2
npm i -DE @microsoft/sp-module-interfaces@1.23.2 @microsoft/eslint-plugin-spfx@1.23.2 @microsoft/eslint-config-spfx@1.23.2 @microsoft/spfx-web-build-rig@1.23.2 @microsoft/spfx-heft-plugins@1.23.2 @rushstack/heft@1.2.17 eslint@9.37.0 @types/jest@30.0.0 typescript@~5.8.0 @typescript-eslint/parser@8.46.2 css-loader@7.1.2 @types/heft-jest@1.0.2
npm pkg set overrides.@rushstack/heft=1.2.17
npm i
npm dedupe
@'
